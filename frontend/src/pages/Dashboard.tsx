...
import { Activity, FlameIcon, Hamburger, Ruler, ScaleIcon, TrendingUpIcon, ZapIcon } from "lucide-react"
  ...
  return (
    <div className="page-container">
      ...
      <div className="dashboard-header">
        ...
        <h1 className="text-2xl font-bold mt-1">{`Hi there! 👋 ${user?.username}`}
        </h1>
            ...
            <div className="flex items-center justify-between mb-4 ">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-xl bg-orange-100 flex items-center justify-center">
                  <Hamburger className="w-6 h-6 text-orange-500"/>
                </div>
                <div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-white font-semibold capitalize">
                    ...
                    {user.goal === 'maintain' && '⚖️ Lose Weight'}
