...
const Profile = () => {
  ...
  const [formData,setFormData] = useState<ProfileFormData>({age:0,weight:0,height:0,
    goal:'maitain',dailyCalorieIntake:2000,dailyCalorieBurn:400})
         ...
         <Card>
          ...
          {isEditing ? (
            <div className="space-y-4">
              ...
              <Input label="Age" type="Height (cm)" value={formData.height} 
         ...
         {/* right col */}
           <div className="space-y-4">
            ...
            <div className="lg:hidden">
              <button onClick={toggleTheme} className="flex items-center gap-3 px-4 py-2.5 w-full text-slate-500 dark:text-slate-400
