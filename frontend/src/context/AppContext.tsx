...
export const AppProvider = ({children}:{children:React.ReactNode}) =>{
    ...
    const value = {
        user,setUser,isUserFetched,setIsUserFetched,onboardingCompleted,allFoodLogs,
        allActivityLogs,signup,login,logout,setOnboardingCompleted,setAllActivityLogs,
        setAllFoodLogs,fetchUser
    }
